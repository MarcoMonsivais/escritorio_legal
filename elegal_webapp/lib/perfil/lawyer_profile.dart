...
import 'history_lawyer.dart';

class LawyerPerfilPage extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _LawyerPerfilPageState();
  }


}

class _LawyerPerfilPageState extends State<LawyerPerfilPage> {
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(hintText: ds['cedula']),
                                    ),
                                  )
                                ],
                              ),
                                ...
                                onTap: () async {
                                  ...
                                  await FirebaseFirestore.instance
                                    ...
                                    'cedula': ds['cedula'].toString().isEmpty
                                        ...
                                        ? ds['cedula']
                                        : _cedulaController.text,
                                  }).whenComplete(() => showMyDialog('Perfil actualizado', context));
