...
class HistoryLawyerPage extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _HistoryLawyerPageState();
  }

}

class _HistoryLawyerPageState extends State<HistoryLawyerPage> {
  ...
  void _handleFileSelection() async {
    ...
    try {
      final reference = FirebaseStorage.instance.ref('e_legal/conf/history/' + room.id + '/' + name);
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  onTap: () => Navigator.of(context).pushNamedAndRemoveUntil('/welcomeagent', (Route<dynamic> route) => false),
                  child: const Padding(
                ...
                GestureDetector(
                    onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => LawyerPerfilPage())),
                      ...
                      return SafeArea(
                        ...
                        child: Column(
                          children: [
                            ...
                            //         'https://firebasestorage.googleapis.com/v0/b/mingdevelopment-site.appspot.com/o/e_legal%2Fconf%2Foth%2FLawyer-PNG-Free-Download.png?alt=media&token=65739b17-8014-4349-9719-70f8fa021a6d',
                            //         height: 150,),),
                            //
