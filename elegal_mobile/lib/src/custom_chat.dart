...
import 'package:e_legal/src/custom_input.dart';
...
class _CustomChatState extends State<CustomChat> {
  ...
  late Future<DocumentSnapshot> _getHistory;
  late Future<DocumentSnapshot> _getRoom;
  ...
  void initState() {
    ...
    _getHistory = FirebaseFirestore.instance
        .collection('e_legal')
        .doc('conf')
        .collection('history')
        .doc(widget.roomId)
    ...
    _getRoom = FirebaseFirestore.instance
        .collection('e_legal')
        .doc('conf')
        .collection('rooms')
        .doc(widget.roomId)
      ...
      FirebaseChatCore.instance.sendMessage(
        types.PartialText(
            text: '¡Hola, ' +
                ...
                userName +
                ' y estaré atendiendo tu caso de tipo ' +
  ...
  Widget _messageBuilder(Object object, BoxConstraints constraints) {
    // print('message Builder: ' + object.toString());
    ...
    if (object is DateHeader) {
      ...
      // import 'package:e_legal/chat/audio_message.dart';
