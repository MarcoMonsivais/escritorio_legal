...
///
/// The lawyerList was added in order to mantain the same structure that was
/// before, some functions also need the lawyerList as paremeter to function
/// properly
///
class DashboardScreen extends StatefulWidget {
  static const String id = "dashboard_screen";
  final String currentUserId;
  final List lawyerList;
  DashboardScreen({Key key, @required this.currentUserId, this.lawyerList}) : super(key: key);
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WillPopScope(
        child: ChatWidget.userListStack(widget.currentUserId, widget.lawyerList,context),
...
//         if(documentSnapshot.data()["friends"]!= null) {
//           setState(() {
