...
/// ------------------------------------------------------------------
///
/// # [CustomSoundPlayerUI] is a HTML 5 style audio play bar.
...
/// -----------------------------------------------------------------
///
class CustomSoundPlayerUI extends StatefulWidget {
...
// -----------------------------------------------------------------------------------------------------------
  ...
  /// [CustomSoundPlayerUI.fromLoader] allows you to dynamically provide
  ...
  CustomSoundPlayerUI.fromLoader(
      OnLoad onLoad, {
  ...
  ///
  /// [CustomSoundPlayerUI.fromTrack] Constructs a Playbar with a Track.
  ...
  State<StatefulWidget> createState() {
    return CustomSoundPlayerUIState(
      _track,
      _onLoad,
      enabled: _enabled,
      backgroundColor:
...
/// internal state.
/// @nodoc
class CustomSoundPlayerUIState extends State<CustomSoundPlayerUI> {
    ...
    return Container(
      //height: 70,
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(CustomSoundPlayerUI._barHeight / 2)),
        child: Row(children: [
          SizedBox(
            width: 20,
          ),
